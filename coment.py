...
def fb_comment(cookie, uid, dtsg, comment_text, id_cm):
    ...
    payload = {
      ...
      'variables': json.dumps({
          ...
          "input": {
              ...
              "actor_id": uid,
              "attachments": None,
              "feedback_id": feedback_id,         # <== TRUYỀN VÀO
              "formatting_style": None,
              "message": {
                  "ranges": [],
                  "text": comment_text            # <== TRUYỀN VÀO
              },
              "attribution_id_v2": "",
    ...
    headers = {
      ...
      'Cookie': cookie          # <== CHỈ TRUYỀN COOKIE
    }
    ...
    try:
        ...
        # ===== LƯU LỖI VÀO FILE comment_error.json =====
